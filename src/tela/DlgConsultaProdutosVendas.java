 ...
 * @author peret
 */
public class DlgConsultaProdutosVendas extends javax.swing.JDialog {
    DlgRelatorioInformacaoVendas dlgprodutos;
    /**
     * Creates new form DlgConsultaProdutosVendas
     */
    public DlgConsultaProdutosVendas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public DlgConsultaProdutosVendas(java.awt.Frame parent, boolean modal, DlgRelatorioInformacaoVendas dlgprodutos) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgConsultaProdutosVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgConsultaProdutosVendas dialog = new DlgConsultaProdutosVendas(new javax.swing.JFrame(), true);
